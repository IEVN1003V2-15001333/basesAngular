...
@Component({
  selector: 'app-signo-zodiacal',
  templateUrl: './signo-zodiacal.component.html',
  styleUrls: ['./signo-zodiacal.component.css']
})
export class SignoZodiacalComponent {
  ...
  calcularSigno() {
    ...
    // Muestra la información solo después de hacer clic en "Imprimir"
  ...
  obtenerImagenSignoChino(signoChino: string): string {
    ...
    return imagenesChinas[signoChino as keyof typeof imagenesChinas] || '';  // Aseguramos que es una clave válida
}
}
